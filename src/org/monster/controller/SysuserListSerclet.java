...
public class SysuserListSerclet extends HttpServlet {

	/**
	 * Constructor of the object.
	 */
	public SysuserListSerclet() {
		super();
	}
	...
	public void doPost(HttpServletRequest request, HttpServletResponse response)
		...
		List<Sysuser> SysuserList=dao.getSysuserPageList(10, 1);
		request.setAttribute("SysuserList", SysuserList); 
		request.getRequestDispatcher("all-sysuser.jsp").forward(request, response);
	}
