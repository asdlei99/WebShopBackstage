                ...
                <div class="sidebar-nav">
                  <div class="nav-header" data-toggle="collapse" data-target="#dashboard-menu"><i class="icon-dashboard"></i>图书</div>
                    <ul id="dashboard-menu" class="nav nav-list collapse in">
                        ...
                        <li class="active"><a href="BooksListServlet">所有图书</a></li>
...
<div class="btn-toolbar">
    <a  href="add-books.jsp"><button class="btn btn-primary"><i class="icon-plus"></i> 添加图书</button></a>
    <button class="btn">导入图书</button>
    <button class="btn">导出图书</button>
  <div class="btn-group">
  </div>
</div>
<div class="well">
